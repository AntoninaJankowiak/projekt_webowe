...
const maxId: number=1010; //newest pokemon
const outOfBoundsError: string=`\`Id too big or too small, it needs to be a number between 1 and ${maxId}\``
...
function query_getPokedexEntries(id: number): string{
...
function query_getPreviousAndNextPokemon(id: number): string{
...
function query_getPokemonLocations(id:number): string{
...
function query_getMoveset(id: number, dexId: number): string{
...
function query_getFamily(id: number): string{
